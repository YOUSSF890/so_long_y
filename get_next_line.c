...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/03 10:13:42 by ylagzoul          #+#    #+#             */
/*   Updated: 2025/02/19 16:02:13 by ylagzoul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long.h"

static	char	*chock_read(int fd, char *handel)
{
	char	*buffer;
	int		num;
...
static	char	*get_file_rest(char *buffer)
{
	int		i;
	int		j;
	char	*str;
