...
/*   Updated: 2025/03/08 10:44:29 by ylagzoul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_mlx_imag(t_game *game)
{
	...
	game->wall = mlx_xpm_file_to_image(game->ptr, "textures/wall_imag.xpm", &x, &y);
	game->player = mlx_xpm_file_to_image(game->ptr, "textures/player.xpm", &x, &y);
	game->collectible = mlx_xpm_file_to_image(game->ptr, "textures/collectible_imag.xpm", &x, &y);
	game->exit = mlx_xpm_file_to_image(game->ptr, "textures/exit_imag.xpm", &x, &y);
	game->empty = mlx_xpm_file_to_image(game->ptr, "textures/empty.xpm", &x, &y);
	if (!game->player || !game->exit || !game->wall || !game->collectible || !game->empty)
